    ...
    public partial class Form1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
            ...
            {
              verificador = AccesoDatos.RegresaCadena_1_ResultadoSql("select count(*) from poliza where  cliente = " + this.txtIdCliente.Text + " and  poliza = '" + this.txtPoliza.Text + "' and tipo = 'poliza' ");
                poliza = this.txtPoliza.Text;
            }
            if (panel2.Visible == true)
            {
                verificador = AccesoDatos.RegresaCadena_1_ResultadoSql("select count(*) from poliza where  cliente = " + this.txtIdCliente.Text + " and  poliza = '" + this.comboBox2.Text + "' and tipo = 'poliza' ");
                poliza = this.comboBox2.Text;
            }
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Carta envío ramo 9', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {

                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Carta envío ramo 9', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','')");
            }
            ...
            this.lblId.Text = identificador;
            linkLabel1.Text = "Carta envío ramo 9";
            string url = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + identificador;
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel2.Text = "Carta envío ramo 123";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Carta envío ramo 123', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel3.Text = "Carta envío todos excepto 9 y 123";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Carta envío todos excepto 9 y 123', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel4.Text = "Envío endosos ramo 9";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío endosos ramo 9', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel5.Text = "Envío endosos ramo 123";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío endosos ramo 123', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel6_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel6.Text = "Envío Endosos todos excepto 9 y 123";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío Endosos todos excepto 9 y 123', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel12_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Aviso de Renovación con Condiciones Autos', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel7_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel1.Text = "Envío de Documentos Incendio";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío de Documentos Incendio', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel8_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel1.Text = "Envío de Documentos Equipo Electronico";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío de Documentos Equipo Electronico', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel9_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel1.Text = "Envío de Documentos en blanco";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío de Documentos en blanco', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel10_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel1.Text = "Envío de Documentos Autos";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envío de Documentos Autos', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel13_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (historico == true)
            {
                ...
                linkLabel1.Text = "Envíos Varios en Blanco";
                string navegar = "http://192.168.81.30/DocManagement/Plantilla1.aspx?id=" + id_historico;
                this.webBrowser1.Navigate(navegar);
                MessageBox.Show("Estamos descargando su documento");
                historico = false;
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Envíos Varios en Blanco', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void linkLabel14_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                AccesoDatos.EjecutaQuerySql("insert into CartasClientes(cliente, fecha, poliza, parrafo1, parrafo2, parrafo3,tipo_carta,titulo, nombrecompleto, direccion, apartado, bien, aseguradora, vence, endoso, requerimiento,firma, correo,firma_administrativa,correo_administrativa, Fecha_del_reclamo, Monto_reclamado, Aplicado_a_deducible, Año, Monto_no_cubierto,Monto_pagado,Cheque_No,Coaseguro,Timbre,IVA_no_cubierto,TituloPagina, saludo, contacto) values('" + txtIdCliente.Text + "', getdate() , '" + poliza + "' ,'" + this.txtParrafo1.Text + "',  '" + this.txtParrafo2.Text + "', '" + this.txtParrafo3.Text + "','Aviso de Renovación con Condiciones Incendio', '" + this.txtTitulo.Text + "', '" + this.txtNombreCompleto.Text + "','" + this.txtDireccion.Text + "' ,'" + this.txtApartado.Text + "' ,'" + this.txtBien.Text + "' ,'" + this.txtAseguradora.Text + "','" + this.txtVence.Text + "', '" + this.txtEndoso.Text + "' ,'" + this.txtRequerimientos.Text + "','" + this.txtAgente.Text + "','" + this.txtCorreo.Text + "','" + this.txtFirmaAdministrativa.Text + "','" + this.txtCorreoAdministrativo.Text + "','" + this.txtFechaDeReclamo.Text + "','" + this.txtMontoReclamado.Text + "','" + this.txtAplicadoADeducible.Text + "','" + this.txtAño.Text + "','" + this.txtMontoNoCubierto.Text + "','" + this.txtMontoPagado.Text + "','" + this.txtChequeNumero.Text + "','" + this.txtCoaseguro.Text + "','" + this.txtTimbre.Text + "','" + this.txtIvanoCubierto.Text + "','" + this.txtTituloDeCarta.Text + "','" + this.txtSaludo.Text + "','" + this.comboBox4.SelectedText.ToString() + "')");
            }
            catch (Exception)
            {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Carta envío ramo 9'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Carta envío ramo 123'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Carta envío ramo 123'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Carta envío ramo 123'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta = 'Carta envío ramo 123'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text  = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Carta envío todos excepto 9 y 123'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Carta envío todos excepto 9 y 123'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Carta envío todos excepto 9 y 123'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta = 'Carta envío todos excepto 9 y 123'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Envío Endosos todos excepto 9 y 123'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío Endosos todos excepto 9 y 123'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envío Endosos todos excepto 9 y 123'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta = 'Envío Endosos todos excepto 9 y 123'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Envío endosos ramo 123'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío endosos ramo 123'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío endosos ramo 123'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta =  'Envío endosos ramo 123'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Envío de Documentos Incendio'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío de Documentos Incendio'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envío de Documentos Incendio'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta = 'Envío de Documentos Incendio'");
        ...
        {
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta ='Envío de Documentos Equipo Electronico'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío de Documentos Equipo Electronico'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envío de Documentos Equipo Electronico'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta ='Envío de Documentos Equipo Electronico'");
        ...
        private void radioButton9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta ='Envío de Documentos en blanco'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío de Documentos en blanco'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Documentos en blanco'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta = 'Envío de Documentos en blanco'");
        ...
        private void radioButton10_CheckedChanged(object sender, EventArgs e)
        {
            ...
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta ='Envío de Documentos Autos'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta = 'Envío de Documentos Autos'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Documentos Autos'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta =  'Envío de Documentos Autos'");
        ...
        private void radioButton11_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Cartapacio'");
        ...
        private void radioButton12_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Aviso de Renovación con Condiciones Autos'");
        ...
        private void radioButton13_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Aviso de Renovación con Condiciones Incendio'");
        ...
        private void radioButton14_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envío de Renovación Autos y Daños'");
        ...
        private void radioButton15_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envío de Renovación Vida y Gastos Médicos'");
        ...
        private void radioButton16_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Endoso Autos y Daños'");
        ...
        private void radioButton17_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Renovación  Nueva Autos  Daños'");
        ...
        private void radioButton18_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Documentos'");
        ...
        private void radioButton19_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta =  'Envío de liquidación de reclamo'");
        ...
        private void radioButton20_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta =  'Envío de Cheque y Liquidación de reclamo'");
        ...
        private void radioButton21_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Facturación'");
        ...
        private void radioButton22_CheckedChanged(object sender, EventArgs e)
        {
            ...
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta = 'Envío de Endoso Vida y Gastos Médicos'");
        ...
        private void radioButton23_CheckedChanged(object sender, EventArgs e)
        {
            ...
            limipiar_parrafo();
            this.txtParrafo1.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault1 from CartasClientes_Default where NombreCarta = 'Envíos Varios en Blanco'");
            this.txtParrafo2.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault2 from CartasClientes_Default where NombreCarta ='Envíos Varios en Blanco'");
            this.txtTituloDeCarta.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select titulo from CartasClientes_Default where NombreCarta ='Envíos Varios en Blanco'");
            this.txtParrafo3.Text = AccesoDatos.RegresaCadena_1_ResultadoSql("Select ParrafoDefault3 from CartasClientes_Default where NombreCarta =  'Envíos Varios en Blanco'");
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
                ...
                if (this.txtPoliza.Text != "")
            {
                ...
                content = AccesoDatos.RegresaTablaSql("select r.descr, p.poliza, ci.nombre, p.vigf as fecha_vencimiento_contrato, p.endoso, g.gst_nombre, g.gst_correo,co.nombre as administradora, co.email as correo_administradora,  cl.* from poliza p " +
             "    left outer join " +
             ...
             "    on p.cliente = cl.cliente left outer join  corredor co on p.backofficecol = co.corredor " +
             "    where p.poliza = '" + this.txtPoliza.Text.ToString().Trim().Replace("'", "") + "' and secren =  '"+ this.comboBox1.Text.ToString()  +"' and p.tipo = 'poliza' and p.status != 'Cancelada' and secren = (select MAX(secren) from poliza where poliza ='" + this.txtPoliza.Text.ToString().Trim().Replace("'", "") + "' and tipo = 'poliza' and status != 'Cancelada' )");
                ...
                foreach (System.Data.DataRow rw in content.Rows)
                {
                    ...
                    this.txtFirmaAdministrativa.Text = rw["administradora"].ToString();
                    this.txtCorreoAdministrativo.Text = rw["correo_administradora"].ToString();

                    break;
                }
                if (this.txtAgente.Text == this.txtFirmaAdministrativa.Text)
                {
                    this.txtFirmaAdministrativa.Visible = false;
                    this.txtCorreo.Visible = false;
                }
                else {
                    this.txtFirmaAdministrativa.Visible = true;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            this.comboBox2.DataSource = AccesoDatos.RegresaTablaSql("select poliza from poliza where cliente = "+ this.txtIdCliente.Text +"   and tipo = 'poliza' and  poliza not in (Select poliza from poliza where status = 'Cancelada') ");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (this.comboBox2.Text.ToString()  != "")
            {
                ...
                llenado = false;
                System.Data.DataTable content = new System.Data.DataTable();
                content = AccesoDatos.RegresaTablaSql("select r.descr, p.poliza, ci.nombre, p.vigf as fecha_vencimiento_contrato, p.endoso, g.gst_nombre, g.gst_correo,p.coaseguro, co.nombre as administradora, co.email as correo_administradora, cl.* from poliza p " +
             "    left outer join " +
             "   ramos r on p.ramo = r.ramo " +
             "    inner join " +
             "    ciaseg ci on p.cia = ci.cia " +
             ...
             "    where p.poliza = '" + this.comboBox2.Text.ToString().Trim().Replace("'", "") + "' and secren =  '" + this.comboBox1.Text.ToString().Trim() + "' and p.tipo = 'poliza' and p.status != 'Cancelada' and secren = (select MAX(secren) from poliza where poliza ='" + this.comboBox2.Text.ToString().Trim().Replace("'", "") + "' and tipo = 'poliza' and status != 'Cancelada' )");
                ...
                foreach (System.Data.DataRow rw in content.Rows)
                {
                    ...
                    this.txtAgente.Text = rw["gst_nombre"].ToString();
                    this.txtCorreo.Text = rw["gst_correo"].ToString();
                    this.txtCoaseguro.Text = rw["coaseguro"].ToString();
                    this.txtFirmaAdministrativa.Text = rw["administradora"].ToString();
                    this.txtCorreoAdministrativo.Text = rw["correo_administradora"].ToString();
                ...
                this.comboBox4.DataSource = AccesoDatos.RegresaTablaSql("Select nombre from crm_contactos where cliente = " + this.txtIdCliente.Text);
        ...
        {
            string cliente = this.txtIdCliente.Text;

            string sec = "";
            try
            {
              sec =  this.comboBox1.SelectedItem.ToString();
            }
            catch (Exception)
            {
            ...
            if (cliente == "")
            { MessageBox.Show("Debe indicar el codigo del cliente."); return; }

            if (sec == "")
            { MessageBox.Show("Debe indicar la secuencia del cliente."); return; }


            Form frm = new AgregarContacto(cliente, sec);
            frm.Show();
